...
(function(root, factory) {
    ...
    let Input = function() {
        ...
        _.mixin(Input.prototype, EventEmitter, {
            ...
            _checkLanguageDirection: function checkLanguageDirection() {
                let dir = (this.$input.css("direction") || "ltr").toLowerCase();
                if (this.dir !== dir) {
                    this.dir = dir;
    ...
    let Menu = function() {
        ...
        function Menu(o, www) {
            ...
            function initializeDataset(oDataset) {
                let node = that.$node.find(oDataset.node).first();
        ...
        _.mixin(Menu.prototype, EventEmitter, {
            ...
            getActiveSelectable: function getActiveSelectable() {
                let $selectable = this._getSelectables().filter(this.selectors.cursor).first();
                return $selectable.length ? $selectable : null;
            },
            getTopSelectable: function getTopSelectable() {
                let $selectable = this._getSelectables().first();
                return $selectable.length ? $selectable : null;
            },
            update: function update(query) {
    ...
    let DefaultMenu = function() {
        "use strict";
        let s = Menu.prototype;
